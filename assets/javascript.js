            ...
            <ul  class="items-center text-white font-medium text-2xl uppercase flex-wrap *:leading-10 *:p-5 hidden md:flex *:transition-all *:duration-500">
              ...
              <li class="group relative hover:bg-[#4e505b47]">
                <a href="dangkycmd68.html" class="flex items-center">
                  <div class="mr-1 tittle_navbar">Đăng ký CMD368</div>
                  <div>
                    <svg
                      class="h-8 w-8 text-white inline-block transition-all duration-300 group-hover:rotate-180"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      stroke-width="2"
                ...
                <div class="duration-500 opacity-0 z-10 invisible group-hover:visible group-hover:opacity-[1] group-hover:top-[4.97rem] rounded bg-white divide-y divide-gray-100 shadow absolute w-[30rem] left-0 top-[6.97rem]">
                  <ul  class="px-5 text-xl text-gray-500  *:py-4 *:border-b">
                    <li class="hover:text-gray-700">  <a onclick="url()" class="transition-all cursor-pointer" > <span>Tặng miễn phí 100k</span> </a>  </li>
                    <li class="hover:text-gray-900 cursor-pointer"> <a onclick="url()" class="transition-all cursor-pointer" > Khuyến mãi </a> </li>
                  </ul>
                </div>
              </li>
              <li class="group relative hover:bg-[#4e505b47]">
                ...
                <div class="keyframe duration-500 opacity-0 z-10 invisible group-hover:visible group-hover:opacity-[1] group-hover:top-[4.97rem] rounded bg-white divide-y divide-gray-100 shadow absolute w-[30rem] left-0 top-[6.97rem]">
                  <ul  class="px-5 text-xl text-gray-500  *:py-4 *:border-b">
                    <li class="hover:text-gray-700">  <a onclick="url()" class="transition-all cursor-pointer" > Rút tiền </a> </li>
                  </ul>
                </div>
              </li>
